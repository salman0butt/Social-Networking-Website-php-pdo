...
<div class="main_column column">
	...
	<?php
	$user_data_query = $pdo->prepare("SELECT username,first_name, last_name, email FROM users WHERE username=:userLoggedIn");
	$user_data_query->bindValue(':userLoggedIn', $userLoggedIn);
