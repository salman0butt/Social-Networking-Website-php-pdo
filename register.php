...
?>" required><br />
                    <input type="text" name="reg_password" class="form-control" placeholder="Password" required><br />
                    <input type="text" name="reg_confirm_password" class="form-control" placeholder="Confirm Password" required><br />
                    <?php
